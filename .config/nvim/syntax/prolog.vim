...
syntax region  prologCComment     fold start=/\/\*/ end=/\*\// contains=prologTODO
syntax match   prologComment      /%.*/ contains=prologTODO
...
syntax region  prologQuoted       start=/'/ end=/'/ skip=+\\'+ contains=prologQuotedFormat
